...
export const articles = [
  {
    ...
    title: "NEOM, DataVolt Ink $5B Al Deal ",
    description:
      "NEOM partners with DataVolt to build a $5 billion sustainable Al data center in Oxagon, advancing Saudi Arabia's tech ambitions. ",
  ...
  },
  {
    ...
    title: "SingTel Secures $476M Green Loan",
    description:
      "SingTel secures $476M green loan to accelerate sustainable initiatives and reduce carbon footprint across its operations. ",
